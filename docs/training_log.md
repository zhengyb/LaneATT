...
## 20. 2025 May 29, BGR2RGB
- 数据集： 加入修订后的tusimple数据集
- anchors文件： 同上。
- epochs: 40. T_max: 40* 10814
- 最优性能(Valid数据集): ![Metrics](./img/tusimple_metrics_plot-20250529PM1.png)； 
- epoch33在Valid性能：
```JSON
 {'F1': 0.8239749929709079, 'Precision': 0.8608951097287023, 'Recall': 0.790091347373763, 'FPS': 1000.0, 'TP': 24910, 'FP': 4025, 'FN': 6618}
```
- epoch33在Test性能：
```JSON
{
    "test": {
        "F1": 0.8095307226073386,
        "Precision": 0.847357823956236,
        "Recall": 0.7749365945175972,
        "FPS": 1000.0,
        "TP": 22305,
        "FP": 4018,
        "FN": 6478
    ...
    "test_curve_case": {
        "F1": 0.7949595219737857,
        "Precision": 0.8538819875776398,
    ...
    "test_extreme_weather_case": {
        "F1": 0.6739842328684051,
        "Precision": 0.7376875082968273,
        "Recall": 0.6204086189572402,
        "FPS": 1000.0,
        "TP": 5557,
        "FP": 1976,
        "FN": 3400
    ...
    "test_night_case": {
        "F1": 0.7117300996518189,
        "Precision": 0.7348456675343994,
        "Recall": 0.6900244441857758,
        "FPS": 1000.0,
        "TP": 5928,
        "FP": 2139,
        "FN": 2663
    ...
    "test_intersection_case": {
        "F1": 0.6205782802026413,
        "Precision": 0.6984016332221281,
        "Recall": 0.5583598726114649,
        "FPS": 1000.0,
        "TP": 14026,
        "FP": 6057,
        "FN": 11094
    ...
    "test_up_down_case": {
        "F1": 0.7061858560933207,
        "Precision": 0.7362881534323471,
        "Recall": 0.678448275862069,
        "FPS": 1000.0,
        "TP": 6296,
        "FP": 2255,
        "FN": 2984
    ...
    "test_merge_split_case": {
        "F1": 0.7559337214509628,
        "Precision": 0.7927860229194064,
        "Recall": 0.7223553577541938,
        "FPS": 1000.0,
        "TP": 4220,
        "FP": 1103,
        "FN": 1622
    ...
    "test_highway_case": {
        "F1": 0.9475798074925558,
        "Precision": 0.9743662774138422,
        "Recall": 0.9222267151907265,
        "FPS": 1000.0,
        "TP": 6842,
        "FP": 180,
        "FN": 577
